...
<div class="container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="color: black;">Tambah Produk</li>
        </ol>
    </nav>
    @if ($errors->any())
    ...
    <form method="POST" action="/product/store" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="card text-center mx-auto" style="height: 200px; border: 2px dashed #ccc; cursor: pointer;"
                ...
                <img id="image-preview" class="card-img-top" alt="Preview"
                    style="display: none; height: 180px; object-fit: contain">
